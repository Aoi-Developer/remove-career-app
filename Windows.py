...
try:
    subprocess.check_call(r"findstr ""rakuten"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「楽天」")
try:
    subprocess.check_call(r"findstr ""softbank"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「ソフトバンク」")
try:
    subprocess.check_call(r"findstr ""docomo"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「ドコモ」")
try:
    subprocess.check_call(r"findstr ""auone"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「AU」")
try:
    subprocess.check_call(r"findstr ""ntt"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「ドコモ」")
try:
    subprocess.check_call(r"findstr ""kddi"" list.txt >> listout.txt ",shell=True)
except:
    print("例外キャリア「AU」")
try:
